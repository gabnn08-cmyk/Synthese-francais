...
LEGAL_ENTITY_NAME = os.environ.get("LEGAL_ENTITY_NAME", "non communique")
LEGAL_ENTITY_STATUS = os.environ.get("LEGAL_ENTITY_STATUS", "Particulier")
LEGAL_ENTITY_ADDRESS = os.environ.get("LEGAL_ENTITY_ADDRESS", "rayonne_forme4x@icloud.com")
LEGAL_CONTACT_EMAIL = os.environ.get("LEGAL_CONTACT_EMAIL", "rayonne_forme4x@icloud.com")
LEGAL_CONTACT_PHONE = os.environ.get("LEGAL_CONTACT_PHONE", "non communique")
LEGAL_PUBLICATION_DIRECTOR = os.environ.get("LEGAL_PUBLICATION_DIRECTOR", "non communique")
